...
var Scrollable = new Class({
		...
		if (typeOf(element) == 'elements') {
			...
			this.element.addEvents({
				...
				'mousewheel' : function(event) {
					event.stopPropagation(); // Stops the
			...
			this.knob.addEvent('mousedown', function(e) {
				...
				window.addEvent('mouseup', function(e) {
					...
					if (!scrollable.isInside(e)) {
						// If mouse is outside the boundaries of the
						// target element
						scrollable.hideContainer();
					}
	...
	showContainer : function(force) {
		if ((this.options.autoHide && this.options.fade && !this.active) || (force && this.options.fade))
			this.container.fade('in');
		else if ((this.options.autoHide && !this.options.fade && !this.active) || (force && !this.options.fade))
			this.container.fade('show');
	},
