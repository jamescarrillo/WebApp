...
var JpView= new Class({
    ...
    _loadDataFuncionario:function(){
        ...
        viewIzq.setStyle('width',"36%");
        var viewDer= new Element('div',{
            "id":"view-derecha-f"
        });
        viewDer.setStyle('width',"555px");
        viewDer.hide(); 
    ...
    _templateViewFuncionario:function(node){
        ...
        var temp= '<div id="vc-images-f"><img src="./archivos/{foto}" /><a class="button green" href="./archivos/{hojaVida}" target="_blank" style="margin-left:15px">Curriculum</a></div><div id="vc-description-f">';
    ...
    _templateViewConsejo:function(node){
        ...
        var temp= '<div id="vc-images-c"><img src="./archivos/{foto}" /><a class="button green" href="./archivos/{hojaVida}" target="_blank" style="margin-left:15px">Curriculum</a></div><div id="vc-description-c">';
        temp+='<div><label>Nombres y Apellidos:</label><span>{nombresApellidos}</span></div>';
        temp+='<div><label>D.N.I:</label><span>{numeroDni}</span></div>';
        temp+='<div><label>Cargo:</label><span>{cargo}</span></div>';
