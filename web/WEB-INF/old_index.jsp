            ...
            jQuery(document).ready(function() {
                ...
                jQuery.get("./Destacado?action=DestacadoForWeb", function(response) {
                    jQuery(response.items).each(function(index, data) {
                        jQuery(".tp-banner ul").append('<li data-transition="random" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">'
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2 class="h2-title">Nuestras Lineas de Acción</h2>
                        <div class="row">
                        ...
                        <div class="box-p-l">
                            ...
                            <div class="box-service text-center">
                                <div class="agenda-figure">
                                    <img src="resources/images/gerente13.jpg" alt="">
                    ...
                    <div class="col-md-4 col-xs-4 c-ww wow bounceIn" data-wow-duration="1s" data-wow-delay=".5s">
                        <div class="box-team text-center text-curs c-bienes">
                            <a href="./Convocatorias?action=convocatoria" title="">
                                ...
                                <div class="text-conv">
                                    <span>BIENES, SERVICIOS, OBRAS <br>Y CONSECIONES</span>
                                </div>
                            </a>
                        </div>
                    </div>
