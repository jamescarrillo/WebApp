...
<html class="no-js"> <!--<![endif]-->
    <head>
            ...
            window.addEvent("domready", function () {
                ...
                */
                ...
                $("customForm").addEvent("submit", function(e){
                    ...
                    if ($("tema").get("value")==""){
                        error = true;
                        $("tema").getNext().setStyle('color', 'red');
                        $("tema").setStyle('border-color', 'red');
                    }
                    
                    if ($("coment").get("value")==""){
                        error = true;
                        $("coment").getNext().setStyle('color', 'red');
                        $("coment").setStyle('border-color', 'red');
                    }
                    ...
                    this.set('send', {
                        ...
                        onFailure: function(data){
                            $("exitcode").set("html","Se Produjo un problema Al Enviar la consulta, Intentelo Más Tarde");
                        }
                    });
                                ...
                                if(a.msn!=0) {
                                    if (!(error)) {
                                        ...
                                        var $divResult = new Element("div",{
                                            'class' : 'result',
                                            'html'  : '<div style="width:50%; margin: 100px auto; "><div id="exitcode"></div>\n\
        ...
        <title> Consultas y Sugerencias </title>
    </head>
    <body>
        ...
        <div class="wrapper2">
            ...
            <div class="cuerpo">
                <div class="navegacion">
                    <h2>
                        <a href="./Inicio">Inicio</a> / <a href="./ParticipacionCiudadana">Participacion Ciudadana</a> / Consultas y Sugerencias
                    </h2>
                </div>
                ...
                <div class="cdesk" id="cdesk">
                    <div class="sliderPanel">
                        <h2 id="st1">Formulario de Comentarios y Sugerencias</h2>
                        <div id="sp1" style=" width: 800px;  margin: 5px auto;  text-align: left; border:0.1em solid #C3C5CB;">
                            <h1 style="font-weight: 700; font-size: 18px; line-height: 1.2em; margin-left: 5px; border-bottom: 1px dotted rgb(247, 249, 251); color:black; margin-bottom: 1em;">Formulario de Comentarios y Sugerencias</h1>
                            <form id="customForm" method="post" action="./ParticipacionCiudadana?action=insertComentario"  >
                                <div>
                                ...
                                <div>
                                    <label for="tema" style="margin-left: 5px;">Tema:</label>
                                    <input id="tema" class="field"  name="tema" type="text" style="margin-left: 5px;"/>
                                    <span id="temaInfo" class="field"> ¿Cuál es el tema a tratar?</span>			
                                </div>
                                <div>
                                    <label for="coment" style="margin-left: 5px;">Comentario/Sugerencia:</label>
                                    <textarea id="coment" class="field" name="coment" style="margin-left: 5px;"></textarea>
                                    <span id="comentInfo" class="field"> ¿Qué comentario o sugerencia desea hacer?</span>
                                </div>
                                <div>
