...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script>
            ...
            jQuery(document).ready(function () {
                ...
                //Eventos
                jQuery.ajax({
                    url: './Evento?action=EventoForWeb&area=2',
                    dataType: 'json',
                    success: function (response) {
    ...
    <body>
        ...
        <!-- slider -->
        <div class="page-slider bg-slider-main" style="background-image: url('resources/img/ambiental.jpg')" >
            <div class="bg-n">
                <div class="container">
                    <div class="col-md-4 col-md-offset-8 text-center">
                        <img src="resources/img/ambiental_i.png" alt="">
                        <h2>DIRECCI&Oacute;N DE MANEJO AMBIENTAL</h2>
                    </div>
                </div>
            </div>
        </div>  
        ...
        <section class="main-menu-bar">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Dirección de Manejo Ambiental</li>
                </ol>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-9 text-center">
                        ...
                        <ul class="box-funciones wow bounceIn" data-wow-duration="1s" data-wow-delay=".5s">
                            <li>Ejecutar, supervisar, controlar y monitorear las actividades para la conservaci&oacute;n de los recursos naturales.</li>
                            <li>Promover y conducir la ejecuci&oacute;n de estudios sobre inventarios, diagn&oacute;sticos y potencialidades de los recursos naturales en el &aacute;mbito del PEAM.</li>
                            <li>Promover, capacitar y sensibilizar a los diferentes grupos sociales de la poblaci&oacute;n, para que asuman actitudes con sentido de responsabilidad frente al tratamiento de la problem&aacute;tica ambiental.</li>
                            <li>Proponer y diseñar alternativas de uso sostenible de los recursos naturales.</li>
                            <li>Proponer a la Gerencia General la pol&iacute;tica medioambiental en el sector agrario y otros, con la participaci&oacute;n de los dem&aacute;s &oacute;rganos de L&iacute;nea; incorpor&aacute;ndolos en los respectivos expedientes t&eacute;cnicos de las obras y actividades.</li>
                            <li>Formular y elaborar estudios de impacto ambiental en el sector agrario y otros.</li>
                            <li>Monitorear y evaluar el proceso de ejecuci&oacute;n de las actividades a su cargo e informar a la Gerencia General.</li>
                            <li>Facilitar el cumplimiento de las normas legales vigentes inherentes a la protecci&oacute;n y utilizaci&oacute;n de los recursos naturales y el medio ambiente.</li>
                    ...
                    <div class="col-md-3 wow slideInRight" data-wow-duration="1s" data-wow-delay=".6s">
                        <div class="box-service text-center b-sp">
                            <div class="agenda-figure">
                                <img src="resources/img/director_ambiental.jpg" alt="">
                                <div class="agenda-text">
                                    <p>Ing. Marilyn Rivera Briones</p>
                                    <h3>Director(e) de Manejo Ambiental</h3>
                                </div>
                            </div>
