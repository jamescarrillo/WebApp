...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script>
            ...
            jQuery(document).ready(function () {
                ...
                //Eventos
                jQuery.ajax({
                    url: './Evento?action=EventoForWeb&area=1',
                    dataType: 'json',
                    success: function (response) {
    ...
    <body>
        ...
        <!-- slider -->
        <div class="page-slider bg-slider-main" style="background-image: url('resources/img/infraestructura.jpg')" >
            <div class="bg-n">
                <div class="container">
                    <div class="col-md-4 col-md-offset-8 text-center">
                        <img src="resources/img/infraestructura_i.png" alt="">
                        <h2>DIRECCI&Oacute;N DE INFRAESTRUCTURA</h2>
                    </div>
                </div>
            </div>
        </div>  
        ...
        <section class="main-menu-bar">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Dirección de Infraestructura</li>
                </ol>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-9 text-center">
                        ...
                        <ul class="box-funciones wow bounceIn" data-wow-duration="1s" data-wow-delay=".5s">
                            <li>Programar, controlar y supervisar la ejecución de obras que ejecute el Proyecto Especial.</li>
                            <li>Controlar y archivar los expedientes técnicos y planoteca especializada correspondientes a las obras dentro del ámbito del Proyecto Especial.</li>
                            <li>Efectuar el seguimiento a los contratos de ejecución y supervisión de obras, así como los contratos de bienes y servicios relacionados con la ejecución de obras por ejecución presupuestaria directa.</li>
                            <li>Supervisar las labores de mantenimiento y operación de las obras y equipos designados a su Dirección.</li>
                            <li>Dirigir y supervisar los cálculos de valorizaciones de obras y servicios que el Proyecto Especial ejecute.</li>
                            <li>Proponer a la Gerencia General la designación de los Comités para efectos de convocatorias y para la recepción y liquidaciones de obras.</li>
                            <li>Formular informes periódicos de avances de las obras y servicios.</li>
                            <li>Formular el Plan de Actividades y evaluar su cumplimiento.</li>
                        </ul>
                    </div>
                    <div class="col-md-3 wow slideInRight" data-wow-duration="1s" data-wow-delay=".6s">
                        <div class="box-service text-center b-sp">
                            <div class="agenda-figure">
                                <img src="resources/img/director_infraestructura.jpg" alt="">
                                <div class="agenda-text">
                                    <p>Ing. John William Sanchez Rodriguez</p>
                                    <h3>Director de Infraestructura</h3>
                                </div>
                            </div>
