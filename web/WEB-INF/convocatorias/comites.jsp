...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script type="text/javascript">
            ...
            window.addEvent("domready", function () {
                ...
                */
                ...
                var  anhoComite =new Request.HTML({
                    url:'./Convocatoria?action=ListarAnhosDocumentos&cate_id=400' ,
                    onSuccess:function(responseTree, responseElements, responseHTML, responseJavaScript){
                        $("anhosComite").set('html',responseHTML);
                        tblComite= new JpGrid($("tbl-comite"),{
                            id:"gridComite",
                            url:'./Convocatoria?action=Documentos',                   
                            dataQuery:[
                                {name:'anho',value:$("anhosComite").get("value")},
                                {name:'cate_id',value:400},
                                {name:'query',value:$("txtBuscarComite").get("value").replace("&","$$")}
                            ],
                            success: function(e){
                            ...
                            model:[
                                ...
                                {name:"titulo",field:'T&iacute;tulo',width:"12%",sort:true,type:'string'},
                                {name:"resumen",field:'Descripci&oacute;n',width:"75%"},
                                {name:"id",field:'Descargar', style: {"text-align": "center"}, width:"7%",clase:'tips', title:'Explicación' , filtro:'descripcion', activo:'activo' ,type:'string',renderer:function(val){
                                        return '<a class="pdf" target="_blank" href="./GestionTransparente?action=verResolucion&id='+val+'&anho='+ $("anhosComite").get("value")+'"></a>'
                                    }}
                            ]
                        });
                    }
                ...
                $("anhosComite").addEvent("change",function(evt){
                    evt.stopPropagation();
                    tblComite.loadData([
                        {name:'anho',value:$("anhosComite").get("value")},
                        {name:'cate_id',value:400},
                ...
                $("btnBuscarComite").addEvent("click",function(evt){
                    evt.stopPropagation();
                    tblComite.loadData([
                        {name:'anho',value:$("anhosComite").get("value")},
                        {name:'cate_id',value:400},
                ...
                $("txtBuscarComite").addEvent("keypress",function(evt){
                    evt.stopPropagation();
                    if(evt.code==13){
                        tblComite.loadData([
                            {name:'anho',value:$("anhosComite").get("value")},
        ...
        <style type="text/css">
            ...
            .files{border: 1px solid #F58634; margin-left: 5px}


        </style>
        <title>Comit&eacute;s encargados de los procesos y de elaborar las bases de Contrataci&oacute;n </title>
    </head>
    <body>
        ...
        <div class="wrapper2" style="">
            ...
            <div class="cuerpo">
                <div class="navegacion">
                    <h2><a href="./Inicio">Inicio</a> / <a href="./Convocatorias">Selecci&oacute;n de Personal</a> / Comit&eacute;s Encargados </h2>
                </div>
                ...
                <div class="cdesk">
                    ...
                    <div class="sliderPanel">
                        <h2 id="st2" >Comit&eacute;s encargados de los procesos y de elaborar las bases de Contrataci&oacute;n  </h2>
                        <div id="sp2" >
                            <div class="search">
                                <div class="content-l">
                                    <label style="margin-right:15px; font-weight: bold; color: #6A6C71;">Filtrar por A&ntilde;o:</label><select id="anhosComite"></select>
                                </div>
                                <div class="content-i">
                                    <label style="margin-right:15px; font-weight: bold; color: #6A6C71;">Buscar Comite: </label><input  id="txtBuscarComite" style="margin-right:3px" /><button id="btnBuscarComite">Buscar</button>             
                                </div>
                            </div>
                            <div id="tbl-comite" class="grid"></div>  
                        </div>
                    </div>
