        ...
        <script type="text/javascript">
            ...
            window.addEvent("domready", function () {
               ...
               /* $("cab1").addEvent("click",function(){
                ...
                var tblMemorias;
                tblMemorias= new JpGrid($("tbl-memorias"),{
                    id:"gridMemorias",
                    url:'./Publicaciones?action=ListarPublicacionForWeb',                   
                    dataQuery:[
                        {name:'query',value:$("txtBuscarMemorias").get("value").replace("&","$$")},
                        {name:'tipo',value:'1'}
                    ],
                    model:[
                        {name:"anho", field:'Fecha', width:"7%", sort:true, type:'string'},
                        ...
                        {name:"docuId",field:'Descargar',width:"7%", style: {"text-align": "center"}, clase:'tips', title:'Explicación' , filtro:'descripcion', activo:'activo' ,type:'string',renderer:function(val){                                        
                                return '<a class="pdf" target="_blank" href="./GestionTransparente?action=verDocumentosGestion&id='+val+'"></a>'
                            }}
                    ]
                });
                
                $("btnBuscarMemorias").addEvent("click",function(evt){
                    evt.stopPropagation();
                    tblMemorias.loadData([
                        {name:'query',value:$("txtBuscarMemorias").get("value").replace("&","$$")},
                        {name:'tipo',value:'1'}
                    ]);
                });                
                $("txtBuscarMemorias").addEvent("keypress",function(evt){
                    evt.stopPropagation();
                    if(evt.code==13){
                        tblMemorias.loadData([
                            {name:'query',value:$("txtBuscarMemorias").get("value").replace("&","$$")},
        ...
        <div class="wrapper2">
            ...
            <div class="cuerpo">
                <div class="navegacion">
                    <h2><a href="./Inicio">Inicio</a> / <a href="./Publicaciones">Publicaciones</a> / Memorias </h2>
                </div>
                ...
                <div class="cdesk">
                    <div class="sliderPanel">
                        ...
                        <div id="sp1">
                            <div class="search">
                                <div class="content-i">
                                    <label style="margin-right:15px; font-weight: bold; color: #6A6C71;">Buscar: </label><input  id="txtBuscarMemorias" style="margin-right:3px"/><button id="btnBuscarMemorias">Buscar</button>             
                                </div>
                            </div>
                            <div id="tbl-memorias" class="grid"></div>  
                        </div>
                    </div>
                </div>
            </div>
