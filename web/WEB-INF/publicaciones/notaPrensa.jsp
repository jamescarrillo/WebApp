...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script type="text/javascript" src="resources/js/notaPrensa.js"></script>
        ...
        <div class="wrapper2">
            ...
            <div class="cuerpo">
                <div class="navegacion">
                    <h2><a href="./Inicio">Inicio</a> / <a href="./Publicaciones">Publicaciones</a> / Notas de Prensa </h2>
                </div>
                <div class="services text-center">
                    <div class="gadget">
                        <div class="panel active">                            
                            <div class="noticia"></div>
                            <div class="descripcion" class="descripcion" style="font-size:11px"><a>Noticia/Nota Prensa</a></div>
                        </div>
                        <div class="panel">
                ...
                <div class="cdesk">
                    <div id="contenedor-notice">
                        <div id="notice-history">
                            <h2 style="text-align: center; margin-left: 15px;">Historial</h2>
                            <div id="anhos-history">
                            </div>
                        </div>
                        <div id="notice-context"><div id="mensaje"></div></div>
                        <div id="boton-option">
                            <input type="hidden" id="txtLimit" value="6" />
                            <input type="hidden" id="txtStart" value="0" />
                            <input type="hidden" id="txtCurrent" value="0" />
                            <button style="float: right; margin-right: 65px;" hidden="true" class="button green" id="btnSeguir">M&aacute;s Noticias</button>
                        </div>
                    </div>
                </div>
            </div>
