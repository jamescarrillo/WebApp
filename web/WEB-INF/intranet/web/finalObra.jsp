...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/finalObraController.js"></script>
        <link rel="shortcut icon" type="image/x-icon" href="resources/images/16x16/favicon.ico" />
        <title>Monto de Liquidaci&oacute;n final de obra</title>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Monto de Liquidaci&oacute;n final de obra</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Gestione las resoluciones que pertenecen a Liquidaci&oacute;n de final de Obras</div>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridFinalObra.zul" />
                        </div>
                    </div>
