...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/declaracionController.js"></script>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Declaraciones Juradas</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Gestione las documentos  que pertenecen a declaraciones Juradas</div>
                    <div id="frmRegistro" class="ui-widget ui-widget-content" style="display: none;margin: 5px; font-size: 12px;">
                        <z:page>
                            <form id="formRegistro" action="./Convocatoria?action=ActualizarFinalObra">
                                ...
                                <input type="hidden" id="cate_id" name="cate_id" value="1200"/>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridDeclaracion.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
