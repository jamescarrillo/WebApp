...
<html>
    <head>
        ...
        <script type="text/javascript" src="resources/js/admin/controller/anunciosController.js"></script>
        ...
        <div id="cuerpo">
            ...
            <div class="paper" id="paper"  >
                ...
                <div class="contenido">
                    ...
                    <!--<p style="float:right;">Fecha Publicación:  asdasd</p>-->
                </div>
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget-content">
                    <h2 class="ui-widget-header">Administrar Anuncios</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Administre los anuncios de una manera fácil y sencilla</div>
                    <div class="content-marco">
                        <form id="frmBuscador" action="#">
                            <div style="overflow: hidden;padding:5px;font-size:12px;">
                                ...
                                <button id="btnNuevo" dir="nuevo" style="float: right; margin-left:5px;">Nuevo</button>
                        ...
                        <form id="frmRegistroAnuncio" style="display: none;">
                            <div>
                                <label>Fecha Inicio de la publicaci&oacute;n:</label>
                                <input id="fechaInicioPublicacion" readonly="true" type="text" style="width: 100px;"  />
                            </div>
                            <div>
                                <label>Fecha Final de la publicaci&oacute;n:</label>
                                <input id="fechaFinPublicacion" readonly="true" type="text" style="width: 100px;"  />
                            </div>
                            <div>
                                <label>Tipo:</label>
                            ...
                            <div>
                                ...
                                <input id="tituloAnuncio" type="text" />
                            </div>
                            <div>
                                <label>Contenido del Anuncio:</label>
                                <textarea id="contenidoAnuncio" style="width: 649px;height: 200px;font-size: 12px" name="contenidoAnuncio" ></textarea>
                            </div>
                        </form>
                    </div>   
                    <div id="noticias">
                    ...
                    <div id="busqueda-more" class="busqueda-more">
                        <div class="b-izq">
                            ...
                            <button id="btnSeguir" class="button">M&aacute;s Anuncios </button>
                        </div>
                    </div>   
                </div>
            </div>
