...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/dngController.js"></script>
        <link rel="shortcut icon" type="image/x-icon" href="resources/images/16x16/favicon.ico" />
        <title>Actas de Sesión de Consejo Directivo</title>
    </head>
    <body>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Actas de Sesión de Consejo Directivo</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Agrege las Actas de Sesión de Consejo Directivo</div>
                    <div id="frmRegistro" class="ui-widget ui-widget-content" style="display: none;margin: 5px; font-size: 12px;">
                        <z:page>
                            <form id="formRegistro" action="./Convocatoria?action=ActualizarFinalObra">
                                <z:grid>
                                    <z:rows>
                                        <z:row>
                                            ...
                                            <z:hlayout> 
                                                <z:textbox value="" constraint="no empty" maxlength="200" name="titulo" width="250px" tabindex="1" />
                                            </z:hlayout>
                                            <div>
                                        ...
                                        <z:row>
                                            <z:label value="Tipo" width="150px" />
                                            <z:hlayout>
                                                <z:listbox mold="select" width="250px" name="descripcion" hflex="1" >
                                                    <z:listitem value="Ordinaria" label="Ordinaria" selected="true"/>
                                                    <z:listitem value="Extraordinaria" label="Extraordinaria"/>
                                                </z:listbox>
                                            </z:hlayout>
                                            <div>
                                                <label style="width:100%"></label>
                                ...
                                <input type="hidden" id="cate_id" name="cate_id" value="2800"/>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridDng.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
