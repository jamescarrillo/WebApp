...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/laudosController.js"></script>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Laudos</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Gestione documentos Laudos </div>
                    <div id="frmRegistro" class="ui-widget ui-widget-content" style="display: none;margin: 5px; font-size: 12px;">
                        <z:page>
                            <form id="formRegistro" action="./Convocatoria?action=ActualizarFinalObra">
                                ...
                                <input type="hidden" id="cate_id" name="cate_id" value="500"/>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridLaudos.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
