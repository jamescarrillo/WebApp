...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/portalController.js"></script>
        <link rel="shortcut icon" type="image/x-icon" href="resources/images/16x16/favicon.ico" />
        <title>Informes Técnicos Previos de Evaluación de Software  </title>
    </head>
    <body>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Informes Técnicos Previos de Evaluación de Software  </h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Gestione los Documentos desde ArcDig. Informes Técnicos Previos de Evaluación de Software  </div>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridPortal.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
