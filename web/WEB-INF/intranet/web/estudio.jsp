        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget-content">
                    ...
                    <div id="message" class="message ui-widget ui-state-highlight">Administre los proyectos que desea remarcar del Área de Estudios.</div>
                    <div class="content-marco">
                        ...
                        <form id="frmRegistroNoticia" style="display: none;">
                            ...
                            <div>
                                <label>Características de Beneficiarios:</label>
