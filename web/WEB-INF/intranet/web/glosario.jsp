...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/glosarioController.js"></script>
        <link rel="shortcut icon" type="image/x-icon" href="resources/images/16x16/favicon.ico" />
        <title>Registro de Glosario de T&eacute;rminos</title>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Registro de Glosario de T&eacute;rminos</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Agrega T&eacute;rmino de glosarios para el Portal web</div>
                    <div id="frmRegistro" class="ui-widget ui-widget-content" style="display: none;margin: 5px; font-size: 12px;">
                        <z:page>
                            <form id="formRegistro" action="./GestionTransparente?action=ActualizarGlosario">
                                <z:grid>
                                    <z:rows>
                                        <z:row>
                                        ...
                                        <z:row>
                                            <z:label value="Comentarios y Observaciones" width="150px" />
                                            <z:hlayout>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridGlosario.zul" />
                        </div>
                    </div>
