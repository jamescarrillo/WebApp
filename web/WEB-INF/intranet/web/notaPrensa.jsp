...
<html>
    <head>
        ...
        <script type="text/javascript" src="resources/js/admin/controller/notaprensaController.js"></script>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget-content">
                    <h2 class="ui-widget-header">Administrar Notas de Prensa</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Administre sus noticias de una manera m&aacute;s f&aacute;cil, con integraci&oacute;n a Flickr</div>
                    <div class="content-marco">
                        ...
                        <form id="frmRegistroNoticia" style="display: none;">
                            ...
                            <div>
                                <label>Titulo de la nota de prensa:</label>
                                <input id="tituloNotaPrensa" class="casilla" type="text" />
                            </div>
                            <div>
                                <label>contenido de nota de prensa:</label>
                                <textarea id="contenidoNotaPrensa" class="casilla" style="width: 649px; height: 200px; float: left; font-size: 12px" name="contenidoNotaPrensa" ></textarea>
                            </div>
                            <div>
                                <label>fuente de la nota de prensa:</label>
                                <input id="fuenteNotaPrensa" class="casilla" type="text" />
                            </div>
                            <div>
                                <label>foto de la nota de prensa (Flickr):</label>
                                <input id="fotoNotaPrensa" class="casilla" type="text" />
                            </div>
                    ...
                    <div id="busqueda-more" class="busqueda-more">
                        <div class="b-izq">
                            ...
                            <button id="btnSeguir" class="button">M&aacute;s Noticias</button>
                        </div>
                    </div>   
                </div>
            </div>
