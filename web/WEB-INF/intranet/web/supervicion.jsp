...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/supervicionController.js"></script>
        <link rel="shortcut icon" type="image/x-icon" href="resources/images/16x16/favicon.ico" />
        <title>Informes de supervisi&oacute;n</title>
    </head>
    <body>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Informes de supervisi&oacute;n </h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Gestione los documentos  que pertenecen a Informes de supervisi&oacute;n </div>
                    <div id="frmRegistro" class="ui-widget ui-widget-content" style="display: none;margin: 5px; font-size: 12px;">
                        <z:page>
                            <form id="formRegistro" action="./Convocatoria?action=ActualizarFinalObra">
                                ...
                                <input type="hidden" id="cate_id" name="cate_id" value="300"/>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridSupervicion.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
