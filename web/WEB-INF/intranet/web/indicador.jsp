...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/indicadorController.js"></script>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Indicadores de Desempeño</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Agrege los Documentos de Indicadores de Desempeño</div>
                    <div id="frmRegistro" class="ui-widget ui-widget-content" style="display: none;margin: 5px; font-size: 12px;">
                        <z:page>
                            <form id="formRegistro" action="./Convocatoria?action=ActualizarFinalObra">
                                ...
                                <input type="hidden" id="cate_id" name="cate_id" value="900"/>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridIndicador.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
