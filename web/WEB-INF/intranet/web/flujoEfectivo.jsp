...
<html>
    <head>
        ...
        <script  type="text/javascript" src="resources/js/admin/controller/flujoEfectivoController.js"></script>
        <link rel="shortcut icon" type="image/x-icon" href="resources/images/16x16/favicon.ico" />
        <title>Estados de Flujo Efectivo</title>
    </head>
    <body>
        ...
        <div id="cuerpo">
            ...
            <div id="c-izquierdo">
                <div class="marco ui-widget ui-widget-content">
                    <h2 class="ui-widget ui-widget-header ui-corner-top">Estados de Flujos Efectivos</h2>
                    <div id="message" class="message ui-widget ui-state-highlight">Gestione los documentos  que pertenecen a Estados de Flujos Efectivos</div>
                    ...
                    <div id="frm" style="margin:5px;">
                        <div id="grid" >
                            <jsp:include page="./zul/gridFlujoEfectivo.zul" />
                        </div>
                    </div>
                    <!-- fin -->
                </div>
