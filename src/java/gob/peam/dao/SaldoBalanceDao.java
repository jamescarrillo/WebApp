 ...
 * @author alabajos
 */
public class SaldoBalanceDao {

    private SqlSessionFactory sqlSessionFactory;

    public SaldoBalanceDao() {
        sqlSessionFactory = WebAppConnectionFactory.getSqlSessionFactory();
    }
    private static String filter = "";
    private static List<Finanza> items = new SaldoBalanceDao().listItems();
    private static String anho = "";
    private static Finanza selected;
    private static List<Anho> anhos = new SaldoBalanceDao().getListAnhos();
    ...
    public void setSelectedAnho(Anho selectedAnho) {
        SaldoBalanceDao.selectedAnho = selectedAnho;
    }
    ...
    public void setSelected(Finanza selected) {
        SaldoBalanceDao.selected = selected;
    }
                ...
                public void onEvent(Event evt) {
                    if (evt.getName().equals("onOK")) {
                        ...
                        try {
                            ...
                            sqlSession.close();
                            items = listItems();
                            BindUtils.postNotifyChange(null, null, SaldoBalanceDao.this, "*");
                        }
                    }
                }
            });
