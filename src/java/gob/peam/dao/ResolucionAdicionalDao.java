 ...
 * @author alabajos
 */
public class ResolucionAdicionalDao {

    private SqlSessionFactory sqlSessionFactory;

    public ResolucionAdicionalDao() {
        sqlSessionFactory = WebAppConnectionFactory.getSqlSessionFactory();
    }
    private static String filter = "";
    private static List<ResolucionGerencial> items = new ResolucionAdicionalDao().listItems();
    private static String anho = "";
    private static ResolucionGerencial selected;
    private static List<Anho> anhos = new ResolucionAdicionalDao().getListAnhos();
    ...
    public void setAnho(String anho) {
        ResolucionAdicionalDao.anho = anho;
    }
    ...
    public void setSelectedAnho(Anho selectedAnho) {
        ResolucionAdicionalDao.selectedAnho = selectedAnho;
    }
    ...
    public void setAnhos(List<Anho> anho) {
        ResolucionAdicionalDao.anhos = anhos;
    }
    ...
    public void setItems(List<ResolucionGerencial> items) {
        ResolucionAdicionalDao.items = items;
    }
    ...
    public void setFilter(String filter) {
        ResolucionAdicionalDao.filter = filter;
    }
    ...
    public void setSelected(ResolucionGerencial selected) {
        ResolucionAdicionalDao.selected = selected;
    }
    ...
    public ArrayList<ResolucionGerencial> listItems() {
        ...
        try {
            return (ArrayList) session.selectList("ResolucionObra.getListA", hm);
        } finally {
            session.close();
        }
    }
    ...
    public ArrayList<Anho> getListAnhos() {
        SqlSession session = sqlSessionFactory.openSession();
        try {
            return (ArrayList) session.selectList("ResolucionObra.getAnhoA");
        } finally {
            session.close();
        }
    }
                ...
                public void onEvent(Event evt) {
                    if (evt.getName().equals("onOK")) {
                        ...
                        try {
                            ...
                            sqlSession.close();
                            items = listItems();
                            BindUtils.postNotifyChange(null, null, ResolucionAdicionalDao.this, "*");
                        }
                    }
                }
            });
