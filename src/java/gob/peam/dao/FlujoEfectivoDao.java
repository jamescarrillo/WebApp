...
public class FlujoEfectivoDao {
    ...
    public FlujoEfectivoDao() {
        sqlSessionFactory = WebAppConnectionFactory.getSqlSessionFactory();
    }
    private static String filter = "";
    private static List<Finanza> items = new FlujoEfectivoDao().listItems();
    private static String anho = "";
    private static Finanza selected;
    private static List<Anho> anhos = new FlujoEfectivoDao().getListAnhos();
    ...
    public void setSelectedAnho(Anho selectedAnho) {
        FlujoEfectivoDao.selectedAnho = selectedAnho;
    }
    ...
    public void setFilter(String filter) {
        FlujoEfectivoDao.filter = filter;
    }
    ...
    public void setSelected(Finanza selected) {
        FlujoEfectivoDao.selected = selected;
    }
                ...
                public void onEvent(Event evt) {
                    if (evt.getName().equals("onOK")) {
                        ...
                        try {
                            ...
                            sqlSession.close();
                            items = listItems();
                            BindUtils.postNotifyChange(null, null, FlujoEfectivoDao.this, "*");
                        }
                    }
                }
            });
