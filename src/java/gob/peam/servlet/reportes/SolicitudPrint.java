 ...
 * @author alabajos
 */
@WebServlet(name = "SolicitudPrint", urlPatterns = {"/SolicitudPrint"})
public class SolicitudPrint extends HttpServlet {
        ...
        try {
            ...
            switch (formato) {
                case "pdf":
                    ...
                    break;
                case "word":
                    JasperPrint print1 = crearReporte(id);
                ...
                case "excel":
                    JasperPrint print2 = crearReporte(id);
                ...
                case "odt":
                    JasperPrint print3 = crearReporte(id);
            ...
            Logger.getLogger(SolicitudPrint.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
