...
public class OrdenServicio implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = 5699368455007062553L;
    private Integer id;
    private String mes = "";
    private String anho;
    private String nro;
    ...
    public OrdenServicio(Integer id, String anho, String nro, String fecha, String fuenteFinanciamiento, String proveedor, BigDecimal monto, String financiamiento, boolean estado, String nroSiaf) {
        this.id = id;
        this.anho = anho;
        this.nro = nro;
        this.fecha = fecha;
    ...
    public static OrdenServicio load(HSSFRow row) {
        OrdenServicio tpb = new OrdenServicio();
        try {
            tpb.setEstado(true);
