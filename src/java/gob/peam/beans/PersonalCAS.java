 ...
 * @author jprada
 */
public class PersonalCAS implements Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 2730586803008449773L;
	private Integer id;
    private String anho;
    ...
    public PersonalCAS(Integer id, String anho, Integer trimestre, String codigoFormato, String apellidosNombres, String codigoCivil, String oficinaArea, Double remuneracionMensual, boolean estado) {
        this.id = id;
        this.anho = anho;
