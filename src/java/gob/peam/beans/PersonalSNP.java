 ...
 * @author jprada
 */
public class PersonalSNP implements Serializable {
    ...
    public PersonalSNP(Integer id, String anho, Integer trimestre, String codigoFormato, String apellidosNombres, String codigoCivil, String oficinaArea, Double remuneracionMensual, boolean estado) {
        this.id = id;
        this.anho = anho;
